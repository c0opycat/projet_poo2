...
public class KeybindConfigView extends VBox {
  ...
  public void saveKeys() {
    ...
    String forward =
      ((TextField) ((HBox) this.getChildren().get(1)).getChildren()
          .get(1)).getText();
    String backward =
      ((TextField) ((HBox) this.getChildren().get(2)).getChildren()
          .get(1)).getText();
    String right =
      ((TextField) ((HBox) this.getChildren().get(3)).getChildren()
          .get(1)).getText();
    String left =
      ((TextField) ((HBox) this.getChildren().get(4)).getChildren()
          .get(1)).getText();
    String attack =
      ((TextField) ((HBox) this.getChildren().get(5)).getChildren()
          .get(1)).getText();
    String equipment =
      ((TextField) ((HBox) this.getChildren().get(6)).getChildren()
          .get(1)).getText();
    String take =
      ((TextField) ((HBox) this.getChildren().get(7)).getChildren()
          .get(1)).getText();
    String use =
      ((TextField) ((HBox) this.getChildren().get(8)).getChildren()
          .get(1)).getText();
    String backpack =
      ((TextField) ((HBox) this.getChildren().get(9)).getChildren()
          .get(1)).getText();
