...
public class GameView extends BorderWithButtons{
    ...
    {
        return (LocationView)((HBox)((VBox)this.getCenter()).getChildren().get(0)).getChildren().get(0);
    }

    public GridPane getContainersContent()
    {
        return (GridPane)((HBox)((VBox)this.getCenter()).getChildren().get(0)).getChildren().get(1);
    }

    public Button getHelpButton()
    {
        return (Button)((HBox)((VBox)this.getCenter()).getChildren().get(1)).getChildren().get(0);
    }

    public Button getUndoButton()
    {
        return (Button)((HBox)((VBox)this.getCenter()).getChildren().get(1)).getChildren().get(1);
    }

    public Button getPauseButton()
    {
        return (Button)((HBox)((VBox)this.getCenter()).getChildren().get(1)).getChildren().get(2);
    }

    public TextArea getGameInfos()
    {
        return (TextArea)((HBox)((VBox)this.getCenter()).getChildren().get(2)).getChildren().get(0);
    }

    public TextArea getHeroInfos()
    {
        return (TextArea)((HBox)((VBox)this.getCenter()).getChildren().get(2)).getChildren().get(1);
    }
    ...
    private void addContent()
    {
        ...
        contentBox.getChildren().addAll(initGridPanes(), initGameButtons(), initTextInfos());
